...
$route['permisos/(:num)']['get'] = 'RolController/permisos/$1';
...
$route['getByDniCampo']['post'] = 'CampoController/listaByDni';
$route['misContratos']['get'] = 'CampoController/contadorContratos';
$route['clientes-campo']['post'] = 'CampoController/addCliente';
$route['combo-servicios-campo/(:num)']['get'] = 'CampoController/comboServicios/$1';
$route['clientes-interesados-campo']['post'] = 'CampoController/addInteresado';
$route['permisos']['post'] = 'PermisosController/add';
